...
class Kernel extends HttpKernel
{
     ...
     * O grupo "web" é aplicado automaticamente às rotas em "routes/web.php".
     */
    ...
    /**
     * Middlewares atribuíveis às rotas individualmente.
     * Aqui registramos o alias "perfil" para o middleware CheckPerfil.
     */
