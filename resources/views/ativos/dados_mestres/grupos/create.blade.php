...
<div class="max-w-2xl mx-auto bg-white p-6 rounded-2xl shadow-md">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">Cadastrar Novo Grupo</h2>
    ...
    <form action="{{ route('dados_mestres.grupos.store') }}" method="POST">
        @csrf
        ...
        <div class="mb-6">
            ...
            <input type="text" id="Nome" name="Nome" value="{{ old('Nome') }}"
                ...
                required placeholder="Digite o nome do grupo">
        </div>
