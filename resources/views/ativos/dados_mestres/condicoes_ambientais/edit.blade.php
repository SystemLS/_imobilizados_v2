...
<div class="container mx-auto py-8 max-w-3xl">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <h1 class="text-3xl font-bold text-gray-800">✏️ Editar Condição Ambiental</h1>
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg">
        <form action="{{ route('dados_mestres.condicoes_ambientais.update', $condicao->CondicaoAmbientalId) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" id="Nome" name="Nome"
                       ...
                       value="{{ old('Nome', $condicao->Nome) }}" required>
            </div>
