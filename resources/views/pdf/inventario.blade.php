...
<body>
    ...
    <main>
        <div class="modulo-descricao">
            <p><strong>📋 Relatório de Inventário:</strong> {{ $descricao }}</p>
        </div>
        ...
        @if(isset($resumo))
            <div class="resumo-box">
                ...
                <div class="resumo-item">
                    <div class="label">Grupos Cadastrados</div>
                    <div class="valor">{{ $resumo['grupos'] }}</div>
                </div>
                <div class="resumo-item">
                    <div class="label">Categorias</div>
                    <div class="valor">{{ $resumo['categorias'] }}</div>
                </div>
                <div class="resumo-item">
                    <div class="label">Localizações</div>
                    <div class="valor">{{ $resumo['localizacoes'] }}</div>
                </div>
            </div>
        @endif
            ...
            <tbody>
                @forelse($bens as $bem)
                    <tr>
                        ...
                        <td>{{ $bem['grupo'] }}</td>
                        <td>{{ $bem['categoria'] }}</td>
                        <td class="text-muted">{{ $bem['localizacao'] }}</td>
                        <td>
                            <span class="badge badge-{{ $bem['estado_classe'] ?? 'info' }}">
                                {{ $bem['estado'] }}
                            </span>
                        </td>
                    </tr>
        ...
        <div class="rodape-info">
            ...
            <p>Este relatório foi gerado automaticamente pelo Sistema de Gestão de Ativos.
               Os dados apresentados refletem o estado do sistema no momento da geração.</p>
        </div>
    </main>
